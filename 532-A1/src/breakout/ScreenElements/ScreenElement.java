...
public abstract class ScreenElement extends JComponent{  
	...
	*************************/
	...
	// TODO: create enum for directions
	...
	*************************/
	...
	protected void updateLocation(int x_offset, int y_offset) 
	{ 
	...
	public boolean canMoveRight(ScreenElement screenElement, int rightOffset) {
		int x = screenElement.getX();
