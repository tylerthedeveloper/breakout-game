...
public class Constants {
	...
	private static int BUTTON_PANEL_WIDTH = 400;
	public static int getBUTTON_PANEL_WIDTH() {
		return BUTTON_PANEL_WIDTH;
	}
	public static void setBUTTON_PANEL_WIDTH(int bUTTON_PANEL_WIDTH) {
		BUTTON_PANEL_WIDTH = bUTTON_PANEL_WIDTH;
	}
	public static int getBUTTON_PANEL_HEIGHT() {
		return BUTTON_PANEL_HEIGHT;
	}
	public static void setBUTTON_PANEL_HEIGHT(int bUTTON_PANEL_HEIGHT) {
		BUTTON_PANEL_HEIGHT = bUTTON_PANEL_HEIGHT;
	}
	private static int BUTTON_PANEL_HEIGHT = 800;
